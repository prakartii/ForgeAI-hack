...
export function HomePage({ onPickClaim, onOpenFairnessCheck }) {
    ...
    <div className="flex-1 flex flex-col px-5 pb-6">
      <div className="pt-2 pb-5">
        ...
        <p className="text-[13px] text-pinkfaint mt-1.5 leading-relaxed">
          Pick a sample accident to see how FairClaim reviews it, start to finish.
        </p>
      </div>
      ...
      <div className="pt-5 space-y-3">
        <PortalButton disabled={!selected} onClick={() => onPickClaim(selected)}>
          Continue
        </PortalButton>
