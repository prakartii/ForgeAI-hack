...
export const fetchPrismVerdict = () => getJSON('/api/prism/verdict');
...
export const reevaluateRunInPrism = (runId) => postJSON(`/api/prism/runs/${encodeURIComponent(runId)}/reevaluate`);
